...
function Base() {
  ...
  useEffect(() => {
    ...
    Axios.get('https://api.coinstats.app/public/v1/coins/avalanche-2').then((response) => {
    ...
    strongNodeContract = new ethers.Contract('0xFbdDaDD80fe7bda00B901FbAf73803F2238Ae655', strongNodeAbi, ethProvider);
    const avaxProvider = new ethers.providers.getDefaultProvider('https://api.avax.network/ext/bc/C/rpc');
    playmateNodeContract = new ethers.Contract('0xc4a25F823582d9ccf5cf8C8BF5338073e7a51676', playmateNodeAbi, avaxProvider);
    thorNodeContract = new ethers.Contract('0x2be139283d73Cd3a335A94c50BA2B28fdE1E06E1', thorNodeAbi, avaxProvider);
    wavaxContract = new ethers.Contract('0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7', wavaxAbi, avaxProvider);
    nodacContract = new ethers.Contract('0x803e78269f7F013b7D13ba13243Be10C66418a70', nodacAbi, avaxProvider);
  ...
  const getDynamicUserTotalEarnings = async (providerRpc, network) => {
    ...
    const nodac = new ethers.Contract('0x803e78269f7F013b7D13ba13243Be10C66418a70', nodacAbi, dynamicProvider);
  ...
  const giveMeWelfarePlease = async () => {
    ...
    const nodac = new ethers.Contract('0x803e78269f7F013b7D13ba13243Be10C66418a70', nodacAbi, signer);
